...
public class EntityDiamondBossSpawner extends EntityThrowable {
	...
	public EntityDiamondBossSpawner(World w) {
		super(w);
	}

	public EntityDiamondBossSpawner(World w, EntityLivingBase elv) {
		super(w, elv);
	}

	public EntityDiamondBossSpawner(World w, double x, double y, double z) {
		super(w, x, y, z);
	}
