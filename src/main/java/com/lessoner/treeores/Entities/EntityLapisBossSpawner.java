...
public class EntityLapisBossSpawner extends EntityThrowable {
	...
	public EntityLapisBossSpawner(World w) {
		super(w);
	}

	public EntityLapisBossSpawner(World w, EntityLivingBase elv) {
		super(w, elv);
	}

	public EntityLapisBossSpawner(World w, double x, double y, double z) {
		super(w, x, y, z);
	}
