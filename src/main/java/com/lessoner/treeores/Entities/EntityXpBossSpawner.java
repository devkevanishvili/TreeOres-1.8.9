...
public class EntityXpBossSpawner extends EntityThrowable {

	public EntityXpBossSpawner(World w) {
		super(w);
	}

	public EntityXpBossSpawner(World w, EntityLivingBase elv) {
		super(w, elv);
	}

	public EntityXpBossSpawner(World w, double x, double y, double z) {
		super(w, x, y, z);
	}
	...
	protected void onImpact(MovingObjectPosition p_70184_1_) {
		...
		if (!this.worldObj.isRemote) {	
				EntityXpBoss entity = new EntityXpBoss(this.worldObj);
