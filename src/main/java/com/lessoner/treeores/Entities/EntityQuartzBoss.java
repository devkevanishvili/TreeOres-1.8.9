...
public class EntityQuartzBoss extends EntityMob implements IBossDisplayData {
	...
	protected void dropFewItems(boolean par1, int par2) {
		...
		this.entityDropItem(new ItemStack(TreeOresBlocks.TreeOresBossSaplings3, 1, 1), 1);
