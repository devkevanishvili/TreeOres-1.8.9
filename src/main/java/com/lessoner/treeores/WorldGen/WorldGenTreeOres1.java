...
import com.lessoner.treeores.Blocks.TreeOresSaplings1;
 ...
 */
public class WorldGenTreeOres1 extends WorldGenAbstractTree {
        private static final IBlockState logs = TreeOresBlocks.TreeOresLogs1.getDefaultState().withProperty(TreeOresLogs1.VARIANT, TreeOresLogs1.EnumType.IRON);
        private static final IBlockState leaves = TreeOresBlocks.TreeOresLeaves1.getDefaultState().withProperty(TreeOresLeaves1.VARIANT, TreeOresLogs1.EnumType.IRON).withProperty(BlockLeaves.CHECK_DECAY, Boolean.valueOf(false));
        ...
        public WorldGenTreeOres1(boolean doBlockNotify)
        {
            this(doBlockNotify, 4, logs, leaves, false);
        }

        public WorldGenTreeOres1(boolean doBlockNotify, int minTreeHeight, IBlockState metaWood, IBlockState
    ...
    public boolean generate(World worldIn, Random rand, BlockPos position)
    {
        ...
        if (position.getY() >= 1 && position.getY() + i + 1 <= 256)
        {
            ...
            else
            {
                ...
                boolean isSoil = block1.canSustainPlant(worldIn, down, net.minecraft.util.EnumFacing.UP, (TreeOresSaplings1) TreeOresBlocks.TreeOresSaplings1);
