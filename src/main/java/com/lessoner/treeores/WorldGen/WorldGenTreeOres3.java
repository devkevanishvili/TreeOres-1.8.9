...
import com.lessoner.treeores.Blocks.TreeOresSaplings3;
 ...
 */
public class WorldGenTreeOres3 extends WorldGenAbstractTree {
        private static final IBlockState logs = TreeOresBlocks.TreeOresLogs3.getDefaultState().withProperty(TreeOresLogs3.VARIANT, TreeOresLogs3.EnumType.GLOWSTONE);
        private static final IBlockState leaves = TreeOresBlocks.TreeOresLeaves3.getDefaultState().withProperty(TreeOresLeaves3.VARIANT, TreeOresLogs3.EnumType.GLOWSTONE).withProperty(BlockLeaves.CHECK_DECAY, Boolean.valueOf(false));
        ...
        public WorldGenTreeOres3(boolean doBlockNotify)
        {
            this(doBlockNotify, 4, logs, leaves, false);
        }

        public WorldGenTreeOres3(boolean doBlockNotify, int minTreeHeight, IBlockState metaWood, IBlockState
    ...
    public boolean generate(World worldIn, Random rand, BlockPos position)
    {
        ...
        if (position.getY() >= 1 && position.getY() + i + 1 <= 256)
        {
            ...
            else
            {
                ...
                boolean isSoil = block1.canSustainPlant(worldIn, down, EnumFacing.UP, (TreeOresSaplings3) TreeOresBlocks.TreeOresSaplings3);
