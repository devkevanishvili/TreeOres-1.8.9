 ...
 */
public class TreeOresBossSaplings3ItemBlock extends ItemBlock{
    public TreeOresBossSaplings3ItemBlock(Block block) {
        super(block);
        setHasSubtypes(true);
    }
    ...
    public String getUnlocalizedName(ItemStack itemstack) {
        ...
        return  TreeOresLogs3.EnumType.values()[i] + "_boss_sapling";
    }
