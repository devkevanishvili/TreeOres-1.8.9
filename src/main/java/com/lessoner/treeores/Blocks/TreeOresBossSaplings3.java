 ...
 */
public class TreeOresBossSaplings3 extends BlockBush implements IGrowable  {
    ...
    protected TreeOresBossSaplings3()
    {
    ...
    public void generateTree(World worldIn, BlockPos pos, IBlockState state, Random rand)
    {
        ...
        switch ((TreeOresLogs3.EnumType)state.getValue(TYPE)) {
            case GLOWSTONE:
                ...
                leafState = TreeOresBlocks.TreeOresBossLeaves3.getDefaultState().withProperty(TreeOresBossLeaves3.VARIANT, TreeOresLogs3.EnumType.GLOWSTONE).withProperty(BlockLeaves.CHECK_DECAY, Boolean.valueOf(false));
            ...
            case QUARTZ:
                ...
                leafState = TreeOresBlocks.TreeOresBossLeaves3.getDefaultState().withProperty(TreeOresBossLeaves3.VARIANT, TreeOresLogs3.EnumType.QUARTZ).withProperty(BlockLeaves.CHECK_DECAY, Boolean.valueOf(false));
                worldgenerator = new WorldGenTreeOres3(true, 15 + rand.nextInt(7), logState, leafState, false);
                break;
            case XP:
                logState = TreeOresBlocks.TreeOresLogs3.getDefaultState().withProperty(TreeOresLogs3.VARIANT, TreeOresLogs3.EnumType.XP);
                leafState = TreeOresBlocks.TreeOresBossLeaves3.getDefaultState().withProperty(TreeOresBossLeaves3.VARIANT, TreeOresLogs3.EnumType.XP).withProperty(BlockLeaves.CHECK_DECAY, Boolean.valueOf(false));
                worldgenerator = new WorldGenTreeOres3(true, 15 + rand.nextInt(7), logState, leafState, false);
                break;
        }
