 ...
 */
public class TreeOresBossSaplings2 extends BlockBush implements IGrowable  {
    ...
    protected TreeOresBossSaplings2()
    {
    ...
    public void generateTree(World worldIn, BlockPos pos, IBlockState state, Random rand)
    {
        ...
        switch ((TreeOresLogs2.EnumType)state.getValue(TYPE)) {
            case DIAMOND:
                ...
                leafState = TreeOresBlocks.TreeOresBossLeaves2.getDefaultState().withProperty(TreeOresBossLeaves2.VARIANT, TreeOresLogs2.EnumType.DIAMOND).withProperty(BlockLeaves.CHECK_DECAY, Boolean.valueOf(false));
                worldgenerator = new WorldGenTreeOres2(true, 15 + rand.nextInt(7), logState, leafState, false);
                break;
            case EMERALD:
                logState = TreeOresBlocks.TreeOresLogs2.getDefaultState().withProperty(TreeOresLogs2.VARIANT, TreeOresLogs2.EnumType.EMERALD);
                leafState = TreeOresBlocks.TreeOresBossLeaves2.getDefaultState().withProperty(TreeOresBossLeaves2.VARIANT, TreeOresLogs2.EnumType.EMERALD).withProperty(BlockLeaves.CHECK_DECAY, Boolean.valueOf(false));
                worldgenerator = new WorldGenTreeOres2(true,15 + rand.nextInt(7), logState, leafState, false);
                break;
            case LAPIS:
                logState = TreeOresBlocks.TreeOresLogs2.getDefaultState().withProperty(TreeOresLogs2.VARIANT, TreeOresLogs2.EnumType.LAPIS);
                leafState = TreeOresBlocks.TreeOresBossLeaves2.getDefaultState().withProperty(TreeOresBossLeaves2.VARIANT, TreeOresLogs2.EnumType.LAPIS).withProperty(BlockLeaves.CHECK_DECAY, Boolean.valueOf(false));
                worldgenerator = new WorldGenTreeOres2(true, 15 + rand.nextInt(7), logState, leafState, false);
                break;
            case OBSIDIAN:
                logState = TreeOresBlocks.TreeOresLogs2.getDefaultState().withProperty(TreeOresLogs2.VARIANT, TreeOresLogs2.EnumType.OBSIDIAN);
                leafState = TreeOresBlocks.TreeOresBossLeaves2.getDefaultState().withProperty(TreeOresBossLeaves2.VARIANT, TreeOresLogs2.EnumType.OBSIDIAN).withProperty(BlockLeaves.CHECK_DECAY, Boolean.valueOf(false));
                worldgenerator = new WorldGenTreeOres2(true, 15 + rand.nextInt(7), logState, leafState, false);
                break;
        }
    ...
    {
        if(References.EnableBonemealBossTrees) {
