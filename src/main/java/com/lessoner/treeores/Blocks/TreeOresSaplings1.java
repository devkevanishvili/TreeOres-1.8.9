 ...
 */
public class TreeOresSaplings1 extends BlockBush implements IGrowable  {
    ...
    public void generateTree(World worldIn, BlockPos pos, IBlockState state, Random rand)
    {
        ...
        switch ((TreeOresLogs1.EnumType)state.getValue(TYPE)) {
            case IRON:
                ...
                leafState = TreeOresBlocks.TreeOresLeaves1.getDefaultState().withProperty(TreeOresLeaves1.VARIANT, TreeOresLogs1.EnumType.IRON).withProperty(BlockLeaves.CHECK_DECAY, Boolean.valueOf(false));
            ...
            case GOLD:
                ...
                leafState = TreeOresBlocks.TreeOresLeaves1.getDefaultState().withProperty(TreeOresLeaves1.VARIANT, TreeOresLogs1.EnumType.GOLD).withProperty(BlockLeaves.CHECK_DECAY, Boolean.valueOf(false));
                worldgenerator = new WorldGenTreeOres1(true, 4 + rand.nextInt(5), logState, leafState, false);
                break;
            case COAL:
                logState = TreeOresBlocks.TreeOresLogs1.getDefaultState().withProperty(TreeOresLogs1.VARIANT, TreeOresLogs1.EnumType.COAL);
                leafState = TreeOresBlocks.TreeOresLeaves1.getDefaultState().withProperty(TreeOresLeaves1.VARIANT, TreeOresLogs1.EnumType.COAL).withProperty(BlockLeaves.CHECK_DECAY, Boolean.valueOf(false));
                worldgenerator = new WorldGenTreeOres1(true, 4 + rand.nextInt(5), logState, leafState, false);
                break;
            case REDSTONE:
                logState = TreeOresBlocks.TreeOresLogs1.getDefaultState().withProperty(TreeOresLogs1.VARIANT, TreeOresLogs1.EnumType.REDSTONE);
                leafState = TreeOresBlocks.TreeOresLeaves1.getDefaultState().withProperty(TreeOresLeaves1.VARIANT, TreeOresLogs1.EnumType.REDSTONE).withProperty(BlockLeaves.CHECK_DECAY, Boolean.valueOf(false));
                worldgenerator = new WorldGenTreeOres1(true, 4 + rand.nextInt(5), logState, leafState, false);
                break;
        }
