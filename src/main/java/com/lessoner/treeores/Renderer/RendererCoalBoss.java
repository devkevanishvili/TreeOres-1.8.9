...
public class RendererCoalBoss extends RenderBiped {
	...
	public static final ResourceLocation texture = new ResourceLocation(References.MODID + ":" + "textures/entity/coalboss.png");

	protected ModelBoss modelEntity;

	private Object ModelBipedMobRightarm;

	public RendererCoalBoss(RenderManager renderManager, ModelBiped mb, float f) {
		super(renderManager, mb, f, 1.0f);
		this.addLayer(new LayerHeldItem(this));
		modelEntity = ((ModelBoss) mainModel);
	}

	public void renderBoss(EntityCoalBoss entity, double x, double y, double z, float u, float v) {
		BossStatus.setBossStatus(entity, true);
		super.doRender(entity, x, y, z, u, v);
	}

	public void doRenderLiving(EntityLiving entityl, double x, double y, double z, float u, float v) {
		renderBoss((EntityCoalBoss) entityl, x, y, z, u, v);

	}

	public void doRender(Entity entity, double x, double y, double z, float u, float v) {

		renderBoss((EntityCoalBoss) entity, x, y, z, u, v);
