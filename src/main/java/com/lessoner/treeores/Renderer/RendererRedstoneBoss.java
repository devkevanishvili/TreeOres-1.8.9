...
public class RendererRedstoneBoss extends RenderBiped {
	...
	public static final ResourceLocation texture = new ResourceLocation(References.MODID + ":" + "textures/entity/redstoneboss.png");

	protected ModelBoss modelEntity;

	private Object ModelBipedMobRightarm;

	public RendererRedstoneBoss(RenderManager renderManager, ModelBiped mb, float f) {
		super(renderManager, mb, f, 1.0f);
		this.addLayer(new LayerHeldItem(this));
		modelEntity = ((ModelBoss) mainModel);
	}

	public void renderBoss(EntityRedstoneBoss entity, double x, double y, double z, float u, float v) {
		BossStatus.setBossStatus(entity, true);
		super.doRender(entity, x, y, z, u, v);
	}

	public void doRenderLiving(EntityLiving entityl, double x, double y, double z, float u, float v) {
		renderBoss((EntityRedstoneBoss) entityl, x, y, z, u, v);

	}

	public void doRender(Entity entity, double x, double y, double z, float u, float v) {

		renderBoss((EntityRedstoneBoss) entity, x, y, z, u, v);
